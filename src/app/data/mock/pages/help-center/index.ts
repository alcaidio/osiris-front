...
export class HelpCenterMockApi implements TreoMockApi {
  ...
  register(): void {
    ...
    // @ FAQs - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/pages/help-center/faqs').reply((request) => {
    ...
    // @ Guides - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/pages/help-center/guides').reply((request) => {
      // Get the slug & limit
      const slug = request.params.get('slug')
    ...
    // @ Guide - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/pages/help-center/guide').reply((request) => {
      // Get the slugs

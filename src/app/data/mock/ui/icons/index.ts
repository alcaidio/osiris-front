...
export class IconsMockApi implements TreoMockApi {
  ...
  register(): void {
    ...
    // @ Dripicons icons - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/ui/icons/dripicons').reply(() => {
      return [
        200,
        {
          namespace: 'dripicons',
    ...
    // @ Feather icons - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/ui/icons/feather').reply(() => {
      return [
        200,
        {
          namespace: 'feather',
    ...
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/ui/icons/heroicons-outline').reply(() => {
      return [
        200,
        {
    ...
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/ui/icons/heroicons-solid').reply(() => {
      return [
        200,
        {
    ...
    // @ Iconsmind icons - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/ui/icons/iconsmind').reply(() => {
      return [
        200,
        {
          namespace: 'iconsmind',
    ...
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/ui/icons/material-outline').reply(() => {
      return [
        200,
        {
    ...
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/ui/icons/material-twotone').reply(() => {
      return [
        200,
        {
          namespace: '',

...
export class ECommerceInventoryMockApi implements TreoMockApi {
  ...
  register(): void {
    ...
    // @ Categories - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/ecommerce/inventory/categories').reply(() => {
    ...
    // @ Brands - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/ecommerce/inventory/brands').reply(() => {
      return [200, cloneDeep(this._brands)]
    })

    // -----------------------------------------------------------------------------------------------------
    // @ Products - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/ecommerce/inventory/products', 625).reply((request) => {
    ...
    // @ Product - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/ecommerce/inventory/product').reply((request) => {
    ...
    // @ Product - PUT
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPut('api/apps/ecommerce/inventory/product').reply(() => {
    ...
    // @ Product - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/ecommerce/inventory/product').reply((request) => {
    ...
    // @ Product - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/ecommerce/inventory/product').reply((request) => {
      // Get the id
      const id = request.params.get('id')
    ...
    // @ Tags - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/ecommerce/inventory/tags').reply(() => {
    ...
    // @ Tags - PUT
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPut('api/apps/ecommerce/inventory/tag').reply((request) => {
      // Get the tag
    ...
    // @ Tags - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/ecommerce/inventory/tag').reply((request) => {
      // Get the id and tag
      const id = request.body.id
    ...
    // @ Tag - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/ecommerce/inventory/tag').reply((request) => {
      // Get the id
      const id = request.params.get('id')
    ...
    // @ Vendors - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/ecommerce/inventory/vendors').reply(() => {
      return [200, cloneDeep(this._vendors)]
    })
  }
}

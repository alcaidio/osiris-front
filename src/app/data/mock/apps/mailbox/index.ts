...
export class MailboxMockApi implements TreoMockApi {
  ...
  register(): void {
    ...
    // @ Settings - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/mailbox/settings').reply(() => {
    ...
    // @ Settings - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/mailbox/settings').reply((request) => {
      // Get the settings
    ...
    // @ Folders - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/mailbox/folders').reply(() => {
      let count = 0
    ...
    // @ Filters - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/mailbox/filters').reply(() => {
      return [200, cloneDeep(this._filters)]
    })

    // -----------------------------------------------------------------------------------------------------
    // @ Labels - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/mailbox/labels').reply(() => {
    ...
    // @ Labels - PUT
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPut('api/apps/mailbox/label').reply((request) => {
      // Get the label
    ...
    // @ Labels - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/mailbox/label').reply((request) => {
    ...
    // @ Labels - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/mailbox/label').reply((request) => {
      // Get the id
    ...
    // @ Mails - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/mailbox/mails', 625).reply((request) => {
    ...
    // @ Mail - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/mailbox/mail').reply((request) => {
    ...
    // @ Mail - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/mailbox/mail').reply((request) => {
      // Get the id and mail
      const id = request.body.id

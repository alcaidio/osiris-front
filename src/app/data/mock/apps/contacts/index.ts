...
import {
  ...
  tags as tagsData,
} from 'app/data/mock/apps/contacts/data'
...
export class ContactsMockApi implements TreoMockApi {
  ...
  register(): void {
    ...
    // @ Contacts - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/contacts/all').reply(() => {
      // Clone the contacts
    ...
    // @ Contacts Search - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/contacts/search').reply((request) => {
    ...
    // @ Contact - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/contacts/contact').reply((request) => {
    ...
    // @ Contact - PUT
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPut('api/apps/contacts/contact').reply(() => {
    ...
    // @ Contact - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/contacts/contact').reply((request) => {
    ...
    // @ Contact - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/contacts/contact').reply((request) => {
      // Get the id
      const id = request.params.get('id')
    ...
    // @ Countries - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/contacts/countries').reply(() => {
    ...
    // @ Tags - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/contacts/tags').reply(() => {
    ...
    // @ Tags - PUT
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPut('api/apps/contacts/tag').reply((request) => {
      // Get the tag
    ...
    // @ Tags - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/contacts/tag').reply((request) => {
      // Get the id and tag
      const id = request.body.id
    ...
    // @ Tag - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/contacts/tag').reply((request) => {
      // Get the id
      const id = request.params.get('id')
    ...
    this._treoMockApiService.onPost('api/apps/contacts/avatar').reply((request) => {

...
export const events = [
  ...
  // Appointments
  {
    ...
    start: moment()
      ...
      .second(0)
      .millisecond(0)
      .add((9 - moment().date(1).day()) % 7, 'day')
      .toISOString(), // First Tuesday of the current month at 10:00
    end: moment().year(9999).endOf('year').toISOString(), // End of the times
    duration: 90, // Minutes
    allDay: false,
  ...
  },
  {
    ...
    start: moment()
      ...
      .second(0)
      .millisecond(0)
      .add((6 - moment().date(1).day()) % 7, 'day')
      .add(1, 'week')
      .toISOString(), // Second Saturday of the current month at 13:00
    end: moment().year(9999).endOf('year').toISOString(), // End of the times
  ...
  },
  {
    ...
    start: moment()
      ...
      .second(0)
      .millisecond(0)
      .add((5 - moment().date(1).day()) % 7, 'day')
      .add(1, 'week')
      .toISOString(), // Second Friday of the current month at 09:00
    end: moment().year(9999).endOf('year').toISOString(), // End of the times

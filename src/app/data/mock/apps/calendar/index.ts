...
export class CalendarMockApi implements TreoMockApi {
  ...
  register(): void {
    ...
    // @ Calendars - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/calendar/calendars').reply(() => {
      // Clone the calendars
    ...
    // @ Calendars - PUT
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPut('api/apps/calendar/calendars').reply((request) => {
    ...
    // @ Calendars - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/calendar/calendars').reply((request) => {
    ...
    // @ Calendars - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/calendar/calendars').reply((request) => {
      // Get the id
    ...
    // @ Events - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/calendar/events').reply((request) => {
    ...
    // @ Event - PUT
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPut('api/apps/calendar/event').reply((request) => {
    ...
    // @ Event - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/calendar/event').reply((request) => {
    ...
    // @ Event - DELETE
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/calendar/event').reply((request) => {
      // Get the id and event
      const id = request.params.get('id')
    ...
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/calendar/recurring-event').reply((request) => {
      ...
      if (mode === 'single') {
        ...
        if (originalEvent.start === recurringEvent.start) {
          ...
          const rruleset = this._generateRuleset(
            recurringEvent,
            moment(recurringEvent.start),
            moment(recurringEvent.end).utc()
          )
      ...
      if (mode === 'all') {
        ...
        this._events[eventIndex] = assign(
          {},
          this._events[eventIndex],
          omit(event, ['id', 'recurringEventId', 'range'])
        )
      }
    ...
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onDelete('api/apps/calendar/recurring-event').reply((request) => {
    ...
    // @ Settings - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/calendar/settings').reply(() => {
      // Clone the settings
    ...
    // @ Settings - PATCH
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onPatch('api/apps/calendar/settings').reply((request) => {
      // Get the settings
    ...
    // @ Weekdays - GET
    // -----------------------------------------------------------------------------------------------------
    this._treoMockApiService.onGet('api/apps/calendar/weekdays').reply(() => {
      // Clone the weekdays

...
export const routes: Route[] = [
  ...
  // Auth routes (guest)
  {
      ...
      children: [
          ...
          {path: 'sign-in', loadChildren: () => import('./modules/pages/sign-in/sign-in.module').then(m => m.AuthSignInModule)},
  ...
  // Auth routes (logged in)
  {
      ...
      children: [
          {path: 'sign-out', loadChildren: () => import('./modules/pages/sign-out/sign-out.module').then(m => m.AuthSignOutModule)},
  ...
  // Admin routes
  {
    ...
    children: [
      ...
      // 404 & Catch all
      {path: '404-not-found', pathMatch: 'full', loadChildren: () => import('./modules/pages/errors/error-404/error-404.module').then(m => m.Error404Module)},
